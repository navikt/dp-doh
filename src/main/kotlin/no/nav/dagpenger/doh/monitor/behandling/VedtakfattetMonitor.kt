...
internal class VedtakfattetMonitor(
        ...
        River(rapidsConnection)
            .apply {
                validate {
                    ...
                    it.requireKey("behandlingId", "utfall", "gjelderDato", "søknadId, automatisk")
    ...
    override fun onPacket(
        ...
        withLoggingContext(mapOf("behandlingId" to behandlingId, "søknadId" to søknadId)) {
            ...
            val automatisk = packet["automatisk"].asBoolean()
            ...
            behandlingVedtakCounter.labels(utfall(utfall), automatisk.toString()).inc()
    ...
    private fun utfall(utfall: Boolean) = if (utfall) "Innvilgelse" else "Avslag"
}
