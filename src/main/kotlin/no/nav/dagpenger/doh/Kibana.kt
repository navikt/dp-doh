...
object Kibana {
    private const val KIBANA_BASE_URL = "https://logs.adeo.no/app/kibana"
    private const val URL_FORMAT = "$KIBANA_BASE_URL#/discover?_a=%s&_g=%s"
    private const val DEFAULT_INDEX = "96e648c0-980a-11e9-830a-e17bbd64b4db"
    ...
    fun createUrl(
        ...
        endTime: String = "now",
        index: String = DEFAULT_INDEX,
    ) = String.format(URL_FORMAT, appState(index, query), globalState(startTime, endTime))
